...
📊 PLAYER STATISTICS:
🔸 Total Info Requests: {data.get('total_info_requests', 'N/A')}
🔸 BKASH Requests: {data.get('total_bkash_requests', 'N/A')}
🔸 FF Requests: {data.get('total_ff_requests', 'N/A')}
"""
    return message
...
🔄 TIP: Try searching for a Free Fire player or BKASH number!
"""
...
"""
    ...
    bot.send_message(message.chat.id, page_msg)
